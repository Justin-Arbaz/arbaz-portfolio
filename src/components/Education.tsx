  ...
  const education = [
    {
      ...
      institute: 'Maulana Mazharul Haque Arabic & Persian University (MMHAPU)',
      period: '2022 – 2025',
      description:
        'Built a strong foundation in computer science and application development, which now underpins my day-to-day frontend engineering work.',
      highlights: [],
    },
    {
      icon: BookOpen,
      ...
      period: '',
      description:
        'HTML, CSS, and JavaScript fundamentals — built responsive projects that led directly into professional frontend work.',
      highlights: [],
    },
  ];
