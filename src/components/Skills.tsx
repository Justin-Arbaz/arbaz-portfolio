...
const Skills = () => {
  ...
  const skills = [
    ...
    { name: 'WCAG Accessibility', proficiency: 80, color: 'from-pink-400 to-pink-600' },
    { name: 'React (working knowledge)', proficiency: 65, color: 'from-blue-400 to-blue-600' },
    { name: 'Laravel (PHP) / MySQL', proficiency: 60, color: 'from-red-400 to-red-600' },
  ];
    ...
    <section id="skills" className="relative py-20 sm:py-32 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900" ref={ref}>
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* ✅ FIXED TEXT — matches CV precisely */}
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Strong in HTML5, CSS3, and modern JavaScript, with working knowledge of React, and backend familiarity in PHP, Laravel, and MySQL for API integration.
          </p>
        </motion.div>
