...
const Experience = () => {
  ...
  const experiences = [
  {
    ...
    description:
      'Architecting and delivering responsive, high-performance user interfaces using HTML5, CSS3, JavaScript, and Bootstrap across multiple government, healthcare, and agriculture platforms.',
    achievements: [
      'Translated complex UI/UX designs into clean, scalable, reusable frontend components, streamlining development and improving consistency across projects',
      'Integrated REST APIs to power dynamic, data-driven interfaces, collaborating closely with backend Laravel services to ship features end-to-end',
      'Refactored and optimized frontend code for performance, reducing redundancy through reusable, componentized patterns',
      'Enforced cross-browser compatibility and WCAG accessibility standards across all public-facing pages, ensuring usability for government and regulatory audiences',
    ],
  },
];
